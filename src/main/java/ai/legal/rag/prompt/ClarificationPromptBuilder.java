...
public class ClarificationPromptBuilder {
    ...
    public static String build(String userQuestion, String reason, String historyFacts) {
        ...
        if (historyFacts != null && !historyFacts.isBlank()) {
            builder.append("已确认事实（禁止重复提问这些点）：").append(historyFacts.trim()).append("\n");
        }
    ...
    public static String build(String userQuestion, String reason) {
        return build(userQuestion, reason, null);
    }
}
